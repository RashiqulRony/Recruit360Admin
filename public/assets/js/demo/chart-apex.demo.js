...
var handleRenderApexChart = function() {
	...
	var apexMixedChartOptions = {
		...
		title: {
			text: 'XYZ - Stock Analysis (2018 - 2026)',
			align: 'left',
			offsetX: 110
		},
		xaxis: {
	...
	var apexBubbleChartOptions = {
		...
		series: [
			{ name: 'Bubble1', data: generateBubbleChartData(new Date('11 Feb 2026 GMT').getTime(), 20, { min: 10, max: 60 }) },
			{ name: 'Bubble2', data: generateBubbleChartData(new Date('11 Feb 2026 GMT').getTime(), 20, { min: 10, max: 60 }) },
			{ name: 'Bubble3', data: generateBubbleChartData(new Date('11 Feb 2026 GMT').getTime(), 20, { min: 10, max: 60 }) },
			{ name: 'Bubble4', data: generateBubbleChartData(new Date('11 Feb 2026 GMT').getTime(), 20, { min: 10, max: 60 }) }
		],
		fill: { opacity: 0.8 },

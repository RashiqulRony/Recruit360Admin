    ...
    <div class="theme-panel-content">
        ...
        <div class="row mt-10px pt-3px">
            <div class="col-9 control-label text-body-emphasis fw-bold">
                <div class="d-flex">Dark Mode <span class="badge bg-theme text-theme-color ms-1 position-relative py-4px px-6px d-flex align-items-center">NEW</span></div>
        ...
        <div class="row mt-10px pt-3px">
            <div class="col-9">
                <div class="fw-bold text-body d-flex">
                    RTL Support <span class="badge bg-theme text-theme-color ms-1 position-relative py-4px px-6px d-flex align-items-center">NEW</span>
                </div>
                <div class="lh-sm fs-13px fw-semibold">
                    <small class="text-body-emphasis opacity-50">Easily switch to right-to-left layout for Arabic, Hebrew, and other RTL languages.</small>
                </div>
            </div>
            <div class="col-3 d-flex">
                <div class="form-check form-switch ms-auto mb-0">
                    <input type="checkbox" class="form-check-input" name="app-theme-rtl-mode" id="appThemeRtl" value="1" />

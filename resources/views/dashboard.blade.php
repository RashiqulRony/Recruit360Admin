    ...
    <div class="row">
        ...
        <div class="col-xl-6 mb-3">
            ...
            <div class="card h-100 overflow-hidden">
                ...
                <!-- BEGIN card-img-overlay -->
                <div class="card-img-overlay d-none d-md-block bg-blue rounded mb-n1 mx-n1" style="background-image: url({{ asset('assets/img/bg/wave-bg.png') }}); background-position: right bottom; background-repeat: no-repeat; background-size: 100%;"></div>
                <!-- END card-img-overlay -->
                ...
                <div class="card-img-overlay d-none d-md-block bottom-0 top-auto">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xl-6 mb-n2">
                            <img src="{{ asset('assets/img/page/dashboard.svg') }}" alt="" class="d-block ms-n3 mb-5" style="max-height: 310px">
                        </div>
                    </div>
                </div>
                <!-- END card-img-overlay -->
                ...
                <div class="col-sm-6">
                    ...
                    <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-orange" style="min-height: 199px;">
                        ...
                        <div class="card-img-overlay mb-n4 me-n4 d-flex" style="bottom: 0; top: auto;">
                            <img src="{{ asset('assets/img/icon/order.svg') }}" alt="" class="ms-auto d-block mb-n3" style="max-height: 105px">
                        </div>
                        <!-- END card-img-overlay -->
